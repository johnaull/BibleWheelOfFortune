package com.gicthus.spinningwheel;
...
public class SpinningWheelView extends View implements WheelRotation.RotationListener {
    ...
    // Use smaller font for BANKRUPT and LOSE TURN
    private final static int TEXT_SIZE30 = 30;
    ...
    public float getWheelTextSize30() {
        return wheelTextSize30;
    }

    public void setWheelTextSize30(float wheelTextSize30) {
        this.wheelTextSize30 = wheelTextSize30;
        invalidate();
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            float wheelTextSize30 = typedArray.getDimension(R.styleable.Wheel_wheel_text_size, TEXT_SIZE30);
            setWheelTextSize30(wheelTextSize30);
    ...
    private void init() {
        ...
        textPaint30= new Paint();
        textPaint30.setStyle(Paint.Style.FILL);
        textPaint30.setColor(wheelTextColor);
        textPaint30.setTextSize(wheelTextSize30);
    ...
    private void drawWheelItems(Canvas canvas) {
        ...
        for (int i = 0; i < getItemSize(); i++) {
            ...
            // Don't show amounts that have a decimal point
            String itemStr = item.toString();
            if(!itemStr.contains(".")){
                //Use smaller font for BANKRUPT and LOSE TURN
                if (itemStr.startsWith("B")||itemStr.startsWith("L")){
                    canvas.drawText(itemStr, x, y, this.textPaint30);
                } else {
                    canvas.drawText(itemStr, x, y, this.textPaint);
                }
            }
            canvas.restore();
